...
namespace API.Interfaces
{
    public interface IProductoRepository
    {
        ...
        Task<Result<PagedList<ProductoDto>>> GetProductosPaginatedAsync(CancellationToken cancellationToken, int kioscoId, int pageNumber, int pageSize, int? categoriaId = null, StockStatus? stockStatus = null, string? searchTerm = null, string? sortColumn = null, string? sortDirection = null);
