...
namespace API.Interfaces
{
    ...
    {
        Task<Result<PagedList<CategoriaDto>>> GetCategoriasAsync(int pageNumber, int pageSize, CancellationToken cancellationToken);
        Task<Result<CategoriaDto>> GetCategoriaByIdAsync(int id, CancellationToken cancellationToken);
