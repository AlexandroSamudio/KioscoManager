...
import { HomeDataService, Feature, Testimonial, Benefit, FooterLink, FooterSection } from '../../_services/home-data.service';
...
export class HomeComponent{
  ...
  readonly isScrolled = this.uiService.isScrolled;
  ...
  getIconPath(iconName: string): string {
    const iconPaths: Record<string, string> = {
      ...
      'shopping-cart': 'M3 3h2l.4 2M7 13h10l4-8H5.4m1.6 8L6 5H3m4 8a2 2 0 100 4 2 2 0 000-4zm10 0a2 2 0 100 4 2 2 0 000-4z',
      'alert-triangle': 'M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0zM12 9v4m0 4h.01',      'bar-chart-3': 'M3 3v18h18M8 17V9m4 8V5m4 12v-7',
      'users': 'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2m8-10a4 4 0 100-8 4 4 0 000 8zm8 6v-2a4 4 0 00-3-3.87m-3-12a4 4 0 010 7.75',
  ...
  getSocialIconPath(iconName: string): string {
    const iconPaths: Record<string, string> = {
      ...
      'instagram': 'M7 2h10a5 5 0 015 5v10a5 5 0 01-5 5H7a5 5 0 01-5-5V7a5 5 0 015-5zm0 2a3 3 0 00-3 3v10a3 3 0 003 3h10a3 3 0 003-3V7a3 3 0 00-3-3H7zm10.5 2.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM12 7a5 5 0 110 10 5 5 0 010-10zm0 2a3 3 0 100 6 3 3 0 000-6z'
    };
    return iconPaths[iconName] ?? '';
  }
